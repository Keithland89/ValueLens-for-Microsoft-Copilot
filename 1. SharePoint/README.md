...
└── Yes → Do you have Fabric capacity?
         ├── Yes → use ../2. Fabric/ (more robust at volume)
...
If you're hitting 1 GB / 2-hour PBI Service refresh caps, switch to [`../2. Fabric/`](../2.%20Fabric/) — Lakehouse handles parsing upstream and gives you Direct Lake performance.
