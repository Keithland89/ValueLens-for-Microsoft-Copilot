...
| Item | Purpose |
|---|---|
| `AI Business Value Dashboard - Sharepoint Path.pbip` | The dashboard. Open in PBI Desktop, fill in parameters, publish to Service. |
...
| Symptom | Move to |
|---|---|
| Need >30 days of accumulated history | [`../Folder/`](../Folder/) or [`../../2. Fabric/`](../../2.%20Fabric/) |
| Refresh hits 1 GB / 2-hour caps | [`../../2. Fabric/`](../../2.%20Fabric/) |
