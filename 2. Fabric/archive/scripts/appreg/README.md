...
If you want **direct upload to SharePoint** instead, use the [`../../../1. SharePoint/Single File/scripts/appreg/`](../../../1.%20SharePoint/Single%20File/scripts/appreg/) variants — they upload to a SharePoint document library directly and produce the **pre-parsed format** (different schema).
